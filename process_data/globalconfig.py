...
config_json = open("./process_data/global_config.json", "r")
...
# used to load frame relation xml file
FRAME_REL_FILE = FN_DATA_DIR + "frRelation.xml"
FRAME_REL_DIR = DATA_DIR + "frame_relation" + "/" + "fn" + VERSION + "/"
FE_REL_DIR = DATA_DIR + "fe_relation" + "/" + "fn" + VERSION + "/"

# used to store frame def and lu def
FRAME_DEF_DIR = DATA_DIR + "frame_def" + "/" + "fn" + VERSION + "/"
LU_DEF_DIR = DATA_DIR + "lu_def" + "/" + "fn" + VERSION + "/"
MODEL_DATA_DIR = "data/"

# train/dev/test xml file
TEST_FILES = [
        "ANC__110CYL067.xml",
        "ANC__110CYL069.xml",
        "ANC__112C-L013.xml",
